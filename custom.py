...
class Image():
    ...
    def __init__(self):
        ...
        self.connections = {0: [[0, 2, 5], [0, 4, 5], [0, 3, 4], [0, 2, 3]], 1: [[1, 3, 4], [1, 2, 3], [1, 2, 5], [1, 4, 5]], 2: [[1, 3, 4], [0, 4, 5], [0, 3, 4], [1, 4, 5]], 3: [[0, 2, 5], [0, 4, 5], [1, 2, 5], [1, 4, 5]], 4: [[0, 2, 5], [1, 2, 3], [1, 2, 5], [0, 2, 3]], 5: [[1, 3, 4], [1, 2, 3], [0, 3, 4], [0, 2, 3]]}
